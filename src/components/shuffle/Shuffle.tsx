...
export default function Shuffle({
    ...
    () => {
      ...
      const play = () => {
        ...
        const addTween = (targets: HTMLElement[], at: number) => {
          ...
          if (isVertical) {
            vars.y = (i, t) => parseFloat((t as HTMLElement).getAttribute('data-final-y') || '0');
          } else {
            vars.x = (i, t) => parseFloat((t as HTMLElement).getAttribute('data-final-x') || '0');
          }
  ...
  return React.createElement(Tag as string, { ref, className: classes, style: commonStyle } as React.HTMLAttributes<HTMLElement>, text);
}
